...
export const createDocument = async (documentData, userId) => {
  ...
  const qrCodeId = qrCodeService.generateQRCodeId();
  const qrCodeUrl = qrCodeService.generateQRCodeUrl(qrCodeId);
  ...
  qrCodeService.triggerQRCodeGenerationHook({
    id: document.id,
  ...
  qrCodeService.triggerNotificationHook(document.recipientEmail, {
    id: document.id,
    title: document.title,
    referenceNumber: document.referenceNumber,
    qrCodeUrl
 ...
 */
export const getDocumentById = async (id, userId, userRole, userEmail) => {
 ...
 */
export const getAllDocuments = async (filters, userId, userRole, userEmail) => {
 ...
 */
export const updateDocument = async (id, updateData, userId, userRole) => {
  const document = await prisma.document.findUnique({
    where: { id }
  });
